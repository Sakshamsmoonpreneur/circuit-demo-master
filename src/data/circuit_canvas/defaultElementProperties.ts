...
import { PaletteElementType } from "@/types/circuit_canvas/circuit";
...
export const ELEMENT_PALETTE: PaletteElement[] = [
  {
    type: "lightbulb",
    label: "Lightbulb",
    iconPath: "/circuit_canvas/elements/bulb.svg",
    defaultProps: { resistance: 81 },
  },
  {
    type: "battery",
    label: "Battery",
    iconPath: "/circuit_canvas/elements/battery.svg",
    defaultProps: { voltage: 9, resistance: 1 },
  },
  {
    type: "resistor",
    label: "Resistor",
    iconPath: "/circuit_canvas/elements/resistor.svg",
    defaultProps: { resistance: 5 },
  },
  {
    type: "multimeter",
    label: "Multimeter",
    iconPath: "/circuit_canvas/elements/Multimeter.svg",
    defaultProps: { mode: "voltage" },
  },
  {
    type: "potentiometer",
    label: "Potentiometer",
    iconPath: "/circuit_canvas/elements/potentiometer.svg",
    defaultProps: { resistance: 100, ratio: 0.5 },
  },
  {
    type: "led",
    label: "Led",
    iconPath: "/circuit_canvas/elements/led.svg",
  ...
  },
  {
    type: "microbit",
    label: "Microbit",
    iconPath: "/circuit_canvas/elements/microbit.svg",
  },
];
