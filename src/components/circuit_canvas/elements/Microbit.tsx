...
import {
  BaseElement,
  BaseElementProps,
} from "@/components/circuit_canvas/core/BaseElement";
...
export default function Microbit({
  ...
  useEffect(() => {
    ...
    image.src = "/circuit_canvas/elements/microbit.svg";
  ...
  useEffect(() => {
    const image = new window.Image();
    image.src = "/circuit_canvas/elements/microbit_usb_onn.svg";
  ...
  useEffect(() => {
    const image = new window.Image();
    image.src = "/circuit_canvas/elements/microbit_usb_off.svg";
