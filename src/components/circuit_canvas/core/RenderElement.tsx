...
import { CircuitElement } from "@/types/circuit_canvas/circuit";
import { Rect, Group, Text, Label, Tag } from "react-konva"; // <-- Add Text
import { KonvaEventObject } from "konva/lib/Node";
import Lightbulb from "@/components/circuit_canvas/elements/Lightbulb";
import Battery from "@/components/circuit_canvas/elements/Battery";
import Led from "@/components/circuit_canvas/elements/Led";
import Resistor from "@/components/circuit_canvas/elements/Resistor";
import Multimeter from "@/components/circuit_canvas/elements/Multimeter";
import Potentiometer from "@/components/circuit_canvas/elements/Potentiometer";
import Microbit from "@/components/circuit_canvas/elements/Microbit";
