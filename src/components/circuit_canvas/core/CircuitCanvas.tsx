...
import { CircuitElement, EditingWire, Wire } from "@/types/circuit_canvas/circuit";
import RenderElement from "@/components/circuit_canvas/core/RenderElement";
import { DebugBox } from "@/components/debugger/DebugBox";
import createElement from "@/utils/circuit_canvas/createElement";
import solveCircuit from "@/utils/circuit_canvas/kirchoffSolver";
import PropertiesPanel from "@/components/circuit_canvas/core/PropertiesPanel";
import { getCircuitById } from "@/utils/circuit_canvas/circuitStorage";
import Konva from "konva";
import styles from "@/components/circuit_canvas/core/CircuitCanvas.module.css";
import CircuitStorage from "@/components/circuit_canvas/core/CircuitStorage";
import useCircuitShortcuts from "@/hooks/circuit_canvas/useCircuitShortcuts";
import {
  getCircuitShortcuts,
  getShortcutMetadata,
} from "@/utils/circuit_canvas/circuitShortcuts";
// import { Simulator } from "@/lib/code/Simulator";
import { SimulatorProxy as Simulator } from "@/lib/python_code_editor/SimulatorProxy";
import CircuitSelector from "@/components/circuit_canvas/toolbar/panels/Palette";
import { FaArrowRight, FaCode, FaPlay, FaStop } from "react-icons/fa6";
import { VscDebug } from "react-icons/vsc";
import CodeEditor from "@/components/python_code_editor/CodeEditor";
import Loader from "@/utils/common/loader";
import InfiniteGrid from "@/components/circuit_canvas/core/InfiniteGrid";
import AnimatedCircle from "@/components/circuit_canvas/core/AnimatedCircle";
import {
  ColorPaletteDropdown,
  defaultColors,
} from "@/components/circuit_canvas/toolbar/customization/ColorPallete";
